...
void Minimap::draw(vulkan_app::renderer::Renderer2D& renderer2d, const aoc::map::HexGrid& grid,
                   const aoc::map::FogOfWar& fog, PlayerId player, const CameraController& camera,
        ...
        for (int32_t col = 0; col < gridWidth; ++col) {
            ...
            if (platesOverlay) {
                ...
                if (cat != 0xFFu) {
                    ...
                    tc.r =
                        std::min(1.0f, static_cast<float>((h >> 0) & 0xFFu) / 255.0f * 0.7f + 0.3f);
                    tc.g =
                        std::min(1.0f, static_cast<float>((h >> 8) & 0xFFu) / 255.0f * 0.7f + 0.3f);
                    tc.b = std::min(1.0f,
            ...
            case MO::Resources: {
                ...
                if (res.isValid()) {
                    ...
                    if (v == 0 || v == 1 || v == 7 || v == 10 || v == 11 || v == 20 || v == 151 ||
                        v == 152 || v == 154 || v == 162 || v == 164 || v == 165) {
                        setRGB(0.95f, 0.45f, 0.10f);
                    } else if (v == 2 || v == 3 || v == 5 || v == 6 || v == 12 || v == 153) {
                        setRGB(0.95f, 0.85f, 0.10f);
                    } else if (v == 21 || v == 22 || v == 23 || v == 24 || v == 25 || v == 26 ||
                               v == 27 || v == 28 || v == 32 || v == 33 || v == 34 || v == 160 ||
                               v == 161) {
                        setRGB(0.85f, 0.20f, 0.85f);
                    } else if ((v >= 40 && v <= 47) || v == 4 || v == 8 || v == 9) {
                        setRGB(0.20f, 0.85f, 0.30f);
                    } else if (v == 29 || v == 30 || v == 47 || v == 156 || v == 158 || v == 159 ||
                               v == 155) {
                        setRGB(0.65f, 0.65f, 0.65f);
                    } else if (v == 145 || v == 146 || v == 150 || v == 157 || v == 163 ||
                               v == 166) {
            ...
            case MO::CrustAge: {
                ...
                if (!a.empty() && si < a.size()) {
                    ...
                    setRGB(1.0f - t, (t < 0.5f) ? (t * 2.0f) : (1.0f - (t - 0.5f) * 2.0f), t);
                }
                break;
            }
            case MO::Sediment: {
            ...
            case MO::RockType: {
                ...
                if (!r.empty() && si < r.size()) {
                    switch (r[si]) {
                    case 0:
                        setRGB(0.95f, 0.85f, 0.55f);
                        break;
                    case 1:
                        setRGB(0.20f, 0.30f, 0.55f);
                        break;
                    case 2:
                        setRGB(0.55f, 0.25f, 0.65f);
                        break;
                    case 3:
                        setRGB(0.10f, 0.85f, 0.25f);
                        break;
                    default:
                        break;
                    }
            ...
            case MO::Margins: {
                ...
                if (!m.empty() && si < m.size()) {
                    if (m[si] == 1) {
                        setRGB(0.95f, 0.20f, 0.20f);
                    } else if (m[si] == 2) {
                        setRGB(0.20f, 0.45f, 0.95f);
                    }
                }
                break;
            }
            case MO::Volcanism: {
                ...
                if (!v.empty() && si < v.size() && v[si] != 0) {
                    switch (v[si]) {
                    case 1:
                        setRGB(1.0f, 0.30f, 0.10f);
                        break;
                    case 2:
                        setRGB(1.0f, 0.55f, 0.0f);
                        break;
                    case 3:
                        setRGB(0.55f, 0.05f, 0.35f);
                        break;
                    case 4:
                        setRGB(0.10f, 0.85f, 0.55f);
                        break;
                    case 5:
                        setRGB(1.0f, 1.0f, 0.20f);
                        break;
                    case 6:
                        setRGB(0.85f, 0.85f, 0.85f);
                        break;
                    case 7:
                        setRGB(0.95f, 0.90f, 0.60f);
                        break;
                    default:
                        break;
                    }
            ...
            case MO::Hazard: {
                ...
                if (!h.empty() && si < h.size()) {
                    ...
                    if (lvl > 0 || tsu) {
                        setRGB(0.50f + 0.15f * lvl, (lvl >= 3) ? 0.10f : 0.40f,
                               tsu ? 0.85f : 0.10f);
                    }
                }
                break;
            ...
            case MO::Soil: {
                ...
                if (!s.empty() && si < s.size()) {
                    const float v = s[si];
                    setRGB(0.45f + 0.15f * (1.0f - v), 0.30f + 0.55f * v, 0.20f * (1.0f - v));
                }
                break;
            }
            case MO::Insolation: {
            ...
            case MO::PelagicProd: {
                ...
                if (!p.empty() && si < p.size() && p[si] > 0) {
                    ...
                    setRGB(0.20f * (1.0f - v), 0.30f + 0.65f * v, 0.10f * (1.0f - v));
                }
                break;
            }
            case MO::Habit: {
                ...
                if (!h.empty() && si < h.size()) {
                    ...
                    setRGB(0.20f * (1.0f - v), 0.30f + 0.65f * v, 0.20f);
                }
                break;
            }
            case MO::Trade: {
            ...
            case MO::Cliff: {
                ...
                if (!c.empty() && si < c.size() && c[si] != 0) {
                    switch (c[si]) {
                    case 1:
                        setRGB(0.85f, 0.20f, 0.20f);
                        break;
                    case 2:
                        setRGB(0.20f, 0.30f, 0.85f);
                        break;
                    case 3:
                        setRGB(0.85f, 0.55f, 0.20f);
                        break;
                    case 4:
                        setRGB(0.95f, 0.95f, 1.0f);
                        break;
                    default:
                        break;
                    }
            ...
            default:
                break; // Other overlays use main-map only
            }
    ...
    if (camera.worldWidth() > 0.0f) {
        ...
        if (vpX < mapX) {
            ...
            if (leftW > 1.0f && clampedH2 > 1.0f) {
                renderer2d.drawRect(mapX, clampedY2, leftW, clampedH2, 1.0f, 1.0f, 1.0f, 0.8f,
                                    1.5f);
            }
            if (rightW > 1.0f && clampedH2 > 1.0f) {
                renderer2d.drawRect(rightX, clampedY2, rightW, clampedH2, 1.0f, 1.0f, 1.0f, 0.8f,
                                    1.5f);
            }
            ...
            if (rightW > 1.0f && clampedH2 > 1.0f) {
                renderer2d.drawRect(vpX, clampedY2, rightW, clampedH2, 1.0f, 1.0f, 1.0f, 0.8f,
                                    1.5f);
            }
            if (leftW > 1.0f && clampedH2 > 1.0f) {
                renderer2d.drawRect(mapX, clampedY2, leftW, clampedH2, 1.0f, 1.0f, 1.0f, 0.8f,
            ...
            renderer2d.drawRect(vpX, clampedY2, vpW, clampedH2, 1.0f, 1.0f, 1.0f, 0.8f, 1.5f);
        }
    } else {
        ...
        if (clampedW > 1.0f && clampedH > 1.0f) {
            renderer2d.drawRect(clampedX, clampedY, clampedW, clampedH, 1.0f, 1.0f, 1.0f, 0.8f,
                                1.5f);
        }
    }
}

bool Minimap::containsPoint(float screenX, float screenY, float mapX, float mapY, float mapW,
                            float mapH) const {
    return screenX >= mapX && screenX <= mapX + mapW && screenY >= mapY && screenY <= mapY + mapH;
}

void Minimap::screenToWorld(float screenX, float screenY, float mapX, float mapY, float mapW,
                            float mapH, const aoc::map::HexGrid& grid, float hexSize,
...
void Minimap::drawOverlays(vulkan_app::renderer::Renderer2D& renderer2d,
                           const aoc::map::HexGrid& grid, const std::vector<MinimapPip>& pips,
    ...
    for (const MinimapPip& pip : pips) {
        ...
        if (offset.col < 0 || offset.col >= gridWidth || offset.row < 0 ||
            offset.row >= gridHeight) {
            continue;
        }
