        ...
        if (remaining > 0) {
            ...
            if (payerGold > 0) {
                ...
                if (payerStock.consumeGoods(goods::GOLD_BARS, goldToTransfer)) {
                    ...
                    LOG_WARN("EconomySimulation: consumeGoods failed for good %u "
                             "(payer %u) despite prior availability check",
                             static_cast<unsigned>(goods::GOLD_BARS),
                             static_cast<unsigned>(payer));
                }
            }
        }
        if (remaining > 0) {
            ...
            if (payerSilver > 0) {
                ...
                if (payerStock.consumeGoods(goods::SILVER_COINS, silverToTransfer)) {
                    ...
                    LOG_WARN("EconomySimulation: consumeGoods failed for good %u "
                             "(payer %u) despite prior availability check",
                             static_cast<unsigned>(goods::SILVER_COINS),
                             static_cast<unsigned>(payer));
                }
            }
        }
        if (remaining > 0) {
            ...
            if (payerCopper > 0) {
                ...
                if (payerStock.consumeGoods(goods::COPPER_COINS, copperToTransfer)) {
                    ...
                    LOG_WARN("EconomySimulation: consumeGoods failed for good %u "
                             "(payer %u) despite prior availability check",
                             static_cast<unsigned>(goods::COPPER_COINS),
                             static_cast<unsigned>(payer));
                }
            }
        }
