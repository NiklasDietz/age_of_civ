...
std::vector<CivicDef> buildCivicDefs() {
    ...
    // Era 0: Ancient (with policy unlocks 22-24)
    civics.push_back({CivicId{14}, "State Workforce", EraId{0}, 35, {{CivicId{0}}}, {}, {22}});  // Logistics
    civics.push_back({CivicId{15}, "Early Empire", EraId{0}, 40, {{CivicId{0}}}, {}, {23}});  // Imperialism
    civics.push_back({CivicId{16}, "Mysticism", EraId{0}, 35, {{CivicId{1}}}, {}, {24}});  // Religious Order

    // Era 1: Classical (Drama→25 Drama Festivals, NavalTradition→26 Naval Patrols)
    civics.push_back({CivicId{17}, "Drama and Poetry", EraId{1}, 60, {{CivicId{15}}}, {}, {25}});
    ...
    civics.push_back({CivicId{22}, "Naval Tradition", EraId{1}, 50, {{CivicId{2}}}, {}, {26}});  // Naval Patrols

    // Era 2: Medieval (CivilService→27 Bureaucracy, DivineRight→28 Dual Monarchy)
    civics.push_back({CivicId{23}, "Civil Service", EraId{2}, 130, {{CivicId{3}}}, {}, {27}});
    civics.push_back({CivicId{24}, "Divine Right", EraId{2}, 140, {{CivicId{21}}}, {}, {28}});
    ...
    // Era 5: Modern (Conservation→34 New Deal, Mobilization→31 Total War, Ideology→32 Five-Year Plan)
    civics.push_back({CivicId{35}, "Conservation", EraId{5}, 380, {{CivicId{34}}}, {}, {34}});
    civics.push_back({CivicId{36}, "Mass Media", EraId{5}, 390, {{CivicId{34}}}, {}, {}});
    civics.push_back({CivicId{37}, "Mobilization", EraId{5}, 400, {{CivicId{11}, CivicId{33}}}, {}, {31}});
    civics.push_back({CivicId{38}, "Ideology", EraId{5}, 410, {{CivicId{36}}}, {}, {32}});

    // Era 6: Atomic (Space Race→33 Space Cooperation)
    ...
    civics.push_back({CivicId{42}, "Space Race", EraId{6}, 530, {{CivicId{40}}}, {}, {33}});

    // Era 7: Information (Social Media→35 Information Society)
    civics.push_back({CivicId{43}, "Social Media", EraId{7}, 660, {{CivicId{36}}}, {}, {35}});
