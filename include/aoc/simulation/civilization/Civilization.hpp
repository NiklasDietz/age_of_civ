...
inline constexpr std::array<CivilizationDef, CIV_COUNT> CIV_DEFS = {{
    ...
    {4, "Greece",  "Pericles",      "Plato's Republic",
     "+1 culture per worked forest (Aegean groves).",
     {.cultureFromForest=1}, UnitTypeId{}, BuildingId{},
    ...
    {6, "Japan",   "Hojo Tokimune", "Meiji Restoration",
     "+1 prod and +1 culture per worked forest. +1 sci per active trade route.",
     {.scienceFromTradeRoute=1, .cultureFromForest=1, .productionFromForest=1},
     UnitTypeId{}, BuildingId{},
    ...
    {8, "Aztec",   "Montezuma",     "Legend of the Five Suns",
     "+2 culture and +1 faith per rainforest. +2 faith per kill.",
     {.cultureFromRainforest=2, .faithOnUnitKill=2},
     UnitTypeId{}, BuildingId{},
    ...
    {10, "Russia", "Peter",         "The Grand Embassy",
     "+1 culture per active trade route (Grand Embassy salons).",
     {.cultureFromTradeRoute=1},
     UnitTypeId{}, BuildingId{},
     {{"Moscow", "St Petersburg", "Novgorod", "Kiev", "Kazan", "Samara",
       "Rostov", "Tula", "Smolensk", "Pskov", "Yaroslavl", "Vladimir"}},
     {UnitTypeId{14}, "Cossack", 5, 0, 0, 0},
    ...
    {12, "Mongolia", "Genghis Khan",  "Mongol Horde",
     "+1 mov. +3 combat. +3 strength vs cities. +20 gold/pop on capture.",
     {.combatStrengthBonus=3.0f, .extraMovement=1,
      .combatBonusVsCities=3, .goldOnCityCapture=20},
     UnitTypeId{}, BuildingId{},
    ...
    {13, "Arabia",   "Saladin",       "Last Prophet",
     "+2 faith and +1 culture per trade route. +5% faith.",
     {.faithMultiplier=1.05f, .cultureFromTradeRoute=1, .faithFromTradeRoute=2},
     UnitTypeId{}, BuildingId{},
    ...
    {15, "Scythia",  "Tomyris",       "People of the Steppe",
     "+1 mov. +2 combat. +1 sci and +1 faith per kill (steppe vengeance).",
     {.combatStrengthBonus=2.0f, .extraMovement=1, .scienceOnUnitKill=1, .faithOnUnitKill=1},
     UnitTypeId{}, BuildingId{},
    ...
    {17, "Mali",     "Mansa Musa",    "Songs of the Jeli",
     "+2 trade. +3 gold/+1 culture/+1 science per trade route.",
     {.goldMultiplier=1.05f, .extraTradeRoutes=2, .cultureFromTradeRoute=1,
      .scienceFromTradeRoute=1, .goldFromTradeRoute=3},
     UnitTypeId{}, BuildingId{},
    ...
    {21, "Cree",     "Poundmaker",    "Nihithaw",
     "+2 trade routes. +1 sci/+1 cult/+1 gold per active trade route.",
     {.extraTradeRoutes=2, .cultureFromTradeRoute=1, .scienceFromTradeRoute=1, .goldFromTradeRoute=1},
     UnitTypeId{}, BuildingId{},
    ...
    {27, "Korea",    "Seondeok",      "Three Kingdoms",
     "+1 science per worked Mine (Seowon scholarship).",
     {.scienceFromMine=1},
     UnitTypeId{}, BuildingId{},
    ...
    {29, "Vietnam",  "Ba Trieu",      "Nine Dragon River",
     "+5 combat in forest. +1 culture per rainforest. +1 faith per kill.",
     {.cultureFromRainforest=1, .combatBonusInForest=5, .faithOnUnitKill=1},
     UnitTypeId{}, BuildingId{},
    ...
    {34, "Australia","Curtin",        "Land Down Under",
     "+1 prod per Mine. +4 combat on own territory. +1 cult per rainforest.",
     {.productionFromMine=1, .cultureFromRainforest=1, .combatBonusOwnTerritory=4},
     UnitTypeId{}, BuildingId{},
