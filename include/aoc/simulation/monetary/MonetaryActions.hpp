...
/// be the next stage. The Gold Standard needs Banking; Fiat needs Banking and
/// Printing or Economics, two live partners and low inflation; Digital needs
/// Computers and a mature economy. Every gate leaves the state untouched when
/// it refuses. The AI adopts through this too; the only other writer of the
/// regime is the crisis suspension.
