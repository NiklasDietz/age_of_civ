...
[[nodiscard]] std::vector<hex::AxialCoord> districtCandidateTiles(const aoc::game::GameState& gameState,
                                                                  const aoc::map::HexGrid& grid,
...
[[nodiscard]] float districtTileScore(const aoc::game::GameState& gameState, const aoc::map::HexGrid& grid,
